...
from model.text import count_words, count_syllables_in_sentence, remove_punctuation_tokens
...
def sentence_fre_final(sentence):
...
#print(sentence_fkgl('her daughter was UNK bullied .'))

#print(sentence_fre('her daughter was UNK bullied .'))
